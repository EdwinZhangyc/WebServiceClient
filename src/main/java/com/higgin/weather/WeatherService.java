 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://weather.Higgin.com/", wsdlLocation = "http://localhost:12345/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://weather.Higgin.com/", "WeatherService");
    ...
    public WeatherInterface getWeatherInterfacePort() {
        return super.getPort(new QName("http://weather.Higgin.com/", "WeatherInterfacePort"), WeatherInterface.class);
    }
    ...
    public WeatherInterface getWeatherInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://weather.Higgin.com/", "WeatherInterfacePort"), WeatherInterface.class, features);
    }
