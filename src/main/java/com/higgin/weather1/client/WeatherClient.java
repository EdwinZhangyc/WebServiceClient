package com.higgin.weather1.client;

import com.higgin.weather1.WeatherInterface;
import com.higgin.weather1.WeatherModel;
...
public class WeatherClient {
    ...
    public static void main(String[] args) {
        ...
        //调用地址
        jaxWsProxyFactoryBean.setAddress("http://127.0.0.1:12345/weather1?wsdl");
        //设置portType
